...
//   return (
//     <section className="relative min-h-screen overflow-hidden bg-zinc-950 text-white mesh-bg">
//       <div className="absolute inset-0 opacity-36">
//         <Image src="/assets/advanced/code-screen.jpg" alt="Code on a screen" fill className="object-cover" priority />
//       </div>
//       <div className="absolute inset-0 bg-gradient-to-r from-black via-zinc-950/90 to-zinc-950/70" />
//       <div className="absolute inset-0 grid-lines opacity-55" />
//       <FloatingGlow className="left-10 top-32 h-52 w-52 bg-orange-500/35" />
//       <FloatingGlow className="bottom-20 right-20 h-72 w-72 bg-cyan-500/14" />
...
//               className="inline-flex items-center gap-3 rounded-full border border-orange-400 bg-white/10 px-5 py-2 text-xs font-black uppercase tracking-[0.25em] text-orange-300 backdrop-blur-md"
//             >
...
//               <AnimatedText text="Design. Develop. Inspire." className="gradient-text" />
//             </h1>
...
//             >
//               We build modern websites, web applications, mobile experiences, and business software with clean strategy, sharp design, and scalable React functionality.
//             </motion.p>
...
//             >
//               <Link href="/contact" className="group relative overflow-hidden rounded-full bg-orange-500 px-9 py-4 text-center font-black text-white shadow-glow transition hover:-translate-y-1 hover:bg-orange-600">
...
//               </Link>
//               <Link href="/portfolio" className="rounded-full border border-white/30 bg-white/10 px-9 py-4 text-center font-black text-white backdrop-blur-md transition hover:-translate-y-1 hover:border-orange-400 hover:bg-orange-500">
//                 View Portfolio
//               </Link>
//             </motion.div>
//           </div>
...
//           >
//             <div className="absolute -inset-4 rounded-[2.5rem] bg-sky-500/20 blur-2xl" />
//             <div className="relative overflow-hidden rounded-[2rem] border border-sky-300/20 bg-gradient-to-br from-slate-900/95 via-sky-950/90 to-slate-950/95 p-8 shadow-2xl shadow-black/35 backdrop-blur-xl">
//               <div className="relative mb-8 h-56 overflow-hidden rounded-[1.5rem] border border-sky-300/20 shadow-lg shadow-black/20">
...
//                       className={`h-2 rounded-full transition-all ${activeSlide === index ? 'w-7 bg-amber-400' : 'w-2 bg-sky-100/60 hover:bg-white'}`}
//                     />
//                   ))}
//                 </div>
//               </div>
//               <div className="mb-8 flex items-center justify-between border-b border-sky-200/15 pb-6">
//                 <div>
//                   <p className="text-xs font-bold uppercase tracking-[0.22em] text-sky-300">Aan Nahl Studio</p>
//                   <h2 className="mt-3 max-w-md text-3xl font-black leading-tight text-white">Clean digital products for serious business growth.</h2>
//                 </div>
//                 <div className="grid h-14 w-14 place-items-center rounded-full border border-amber-300/50 bg-amber-400/15 text-xl font-black text-amber-300 shadow-lg shadow-amber-950/20">AN</div>
//               </div>
...
//                   ['24/7', 'Support'],
//                 ].map(([value, label]) => (
//                   <div key={label} className="rounded-2xl border border-sky-300/15 bg-sky-950/45 p-5 shadow-inner shadow-sky-900/20">
//                     <strong className="block text-2xl font-black text-white">{value}</strong>
//                     <span className="mt-1 block text-xs font-semibold text-sky-200/70">{label}</span>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//               className="absolute -bottom-6 right-8 rounded-2xl border border-amber-300/40 bg-amber-400 px-6 py-4 text-slate-950 shadow-xl shadow-black/30"
//             >
//               <strong className="block text-2xl font-black">10+</strong>
//               <span className="text-xs font-bold text-slate-800">Years Experience</span>
//             </motion.div>
//           </motion.div>
//         </div>
//       </div>
